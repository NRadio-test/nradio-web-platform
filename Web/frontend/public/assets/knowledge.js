...
import { loadGalaxyKnowledge, confidenceLabels, sourceLabels } from './galaxy-data.js?v=20260916-10'
import { installGalaxyDeparture } from './galaxy-transition.js?v=20260916-10'
...
try {
  ...
  if (previewCanvas) {
    try {
      const { GalaxyScene } = await import('./galaxy-scene.js?v=20260916-10')
